...
//$MODULE_TABLE_NAME[0] = "parent_link";
...
// 模組最後更新日期
$MODULE_UPDATE="2003-8-29 13:45:00";
...
$button["html"]="網頁列印";
$button["xls"]="MS Office Excel 檔";
$button["doc"]="MS Office Word 檔";
$button["sxc"]="OpenOffice 工作表";
...
$today=date("Y-m-d");
//列出橫向的連結選單模組
//$menu_p = array("name_form.php"=>"*班級名條", "address_book.php"=>"*班級通訊錄","select_behalf.php"=>"*班代表圈選表","absence.php"=>"*出缺席紀錄");
//$menu_p = array("name_form.php"=>"*班級名條", "address_book.php"=>"*班級通訊錄", "address_book2.php"=>"*通訊錄2","select_behalf.php"=>"*班代表圈選表","parent_manage.php"=>"*家長帳號管理","link_parent.php"=>"*聯絡簿管理");
//---------------------------------------------------
//
