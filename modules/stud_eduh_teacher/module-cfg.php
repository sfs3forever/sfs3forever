...
$MODULE_TABLE_NAME[0] = "score_eduh_teacher";  
...
//目錄內程式
$menu_p = array(
"course_setup.php"=>"指定科目教師",
"course_setup2.php"=>"指定特定教師",
"stud_eduh_list.php"=>"學生輔導記錄",
"stud_seme_talk.php"=>"輔導訪談記錄",
"stud_psy_test.php"=>"心理測驗記錄");
