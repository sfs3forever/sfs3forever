...
$MODULE_TABLE_NAME[0] = "stud_service";
$MODULE_TABLE_NAME[1] = "stud_service_detail";
...
//目錄內程式
$school_menu_p = array(
"service_one.php"=>"登錄學生服務學習記錄",
"service_confirm.php"=>"核定(認證)時數",
"service_list.php"=>"查詢學生學期時數",
"service_list_all.php"=>"查詢學生總時數",
"service_seme_list.php"=>"學期資料總表",
"service_item.php"=>"項目編修",
"service_entrance.php"=>"補登轉學生外校資料",
"readme.php"=>"使用說明"
);
...
//服務項目設定
 $SFS_MODULE_SETUP[1] =
	array('var'=>"item", 'msg'=>"服務學習類型(以逗號隔開)", 'value'=>"自治類,交通類,環保類,學術類,活動類,其他類");

 $SFS_MODULE_SETUP[2] =
	array('var'=>"confirm", 'msg'=>"輸入後立刻自動認證時數(即不需通過模組管理員認證核可)?(0否,1是)", 'value'=>"0");
