...
//目錄內程式
$school_menu_p['ldap_readme.php'] = "說明";
$school_menu_p['ldap_setup.php'] = "LDAP伺服器設定";
$school_menu_p['ldap_test.php'] = "LDAP認證測試";
//$school_menu_p['ldap_nologin.php'] = "設定禁止登入的帳號";
