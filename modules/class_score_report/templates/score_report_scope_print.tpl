...
<title>{{$show_year.0}}學年第{{$show_seme.0}}學期{{$m_arr.title}}</title>
</head>
<body>
{{if $m_arr.style}}
<P align="center" style='font-size:{{$m_arr.title_font_size}}; font-family:{{$m_arr.title_font_name}}'>{{$school_long_name}}{{$show_year.0}}學年第{{$show_seme.0}}學期{{$class_name}}{{$m_arr.title}}</P>
...
<P align="center" style='font-size:{{$m_arr.title_font_size}}; font-family:{{$m_arr.title_font_name}}'>{{$school_long_name}}<br>{{$show_year.0}}學年第{{$show_seme.0}}學期{{$class_name}}{{$m_arr.title}}</P>
<table border='2' cellpadding='3' cellspacing='0' style='border-collapse:collapse; font-size:{{$m_arr.text_size}};' bordercolor='#111111' width='100%'>
<tr bgcolor="{{$m_arr.header_bgcolor}}" align="center">
<td rowspan=2>座號</td>
<td rowspan=2>學號</td>
