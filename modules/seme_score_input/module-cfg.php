...
//列出橫向的連結選單模組
$MENU_P= array("creat_table.php"=>"產生表格","import_score.php"=>"匯入成績","trans_san.php"=>"匯入三聯成績");
...
// 使用法：
//
// $ret_array =& get_module_setup("seme_score_input")
//
//
