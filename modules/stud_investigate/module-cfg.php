...
$MODULE_TABLE_NAME[0] = "investigate";
$MODULE_TABLE_NAME[1] = "investigate_record";
...
//目錄內程式  //
$MENU_P = array("readme.php"=>"使用說明","investigate.php"=>"資料填報");
if(checkid($_SERVER['SCRIPT_FILENAME'],1)) {
	$MENU_P['manage.php'] = "調查項目管理";
	$MENU_P['output.php'] = "調查資料匯出";
}
