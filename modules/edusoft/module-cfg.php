...
$MODULE_TABLE_NAME[0] = "softm";
$MODULE_TABLE_NAME[1] = "soft";
...
// 模組最後更新日期
$MODULE_UPDATE="2004/04/04";

//本模組須區分管理權
$MODULE_MAN = 1 ;

//管理權說明
$MODULE_MAN_DESCRIPTION = "具有管理權人員,可授權學生操作軟體管理系統";
...
// 使用法：
//
// $ret_array =& get_module_setup("edusoft")
//
//
...
$SFS_MODULE_SETUP[0] =
	array('var'=>"softman", 'msg'=>"資料管理人員", 'value'=>"");

$SFS_MODULE_SETUP[1] =
	array('var'=>"ap_name", 'msg'=>"程式抬頭", 'value'=>"教學軟體");

$SFS_MODULE_SETUP[2] =
	array('var'=>"row_num", 'msg'=>"每頁顯示筆數", 'value'=>20);

$SFS_MODULE_SETUP[3] =
	array('var'=>"table_bgcolor", 'msg'=>"表格顏色", 'value'=>"#FFEEDD");
