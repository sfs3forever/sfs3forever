...
// $Id: module-cfg.php 6607 2011-10-27 06:28:56Z infodaes $
...
$MODULE_TABLE_NAME[0] = "elective_tea";
$MODULE_TABLE_NAME[1] = "elective_stu";
...
//列出橫向的連結選單模組
$menu_p = array(
"elective_tea.php"=>"分組課程設定",
"elective_stu.php"=>"分組學生設定",
"elective_stu_import.php"=>"分組學生名單匯入",
"elective_paper.php"=>"分組課程報表",
"elective_copy.php"=>"分組學生複製"
);
...
// 使用法：
//
// $ret_array =& get_module_setup("elective")
//
//
