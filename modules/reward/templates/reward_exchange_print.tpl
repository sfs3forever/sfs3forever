...
<table border="0">
<tr>
<td colspan="6"><font size="4">{{$school_base.sch_cname}}轉學生期中獎懲匯入記錄</font></td>
</tr>
<tr>
...
<td align="center" width="50">類別</td>
<td align="center">次數</td>
...
<td align="left"><span style="font-size:10pt;">{{$d.reward_date}}</span></td>
<td align="center"><span style="font-size:10pt;">{{$d.reward_kind}}</span></td>
<td align="center"><span style="font-size:10pt;">{{$d.reward_numbers}}</span></td>
<td align="center"><span style="font-size:10pt;">{{$d.reward_reason}}</span></td>
</tr>
{{/foreach}}
<tr>
<td colspan="7"><hr size="2"></td>
