...
switch ($key) {
	case "確定新增" :
		$sql_insert = "insert into board_check (pro_kind_id,post_office,teacher_sn,teach_title_id,is_admin) values ('$bk_id','$post_office','$teacher_sn','$teach_title_id','$is_admin')";
		mysql_query($sql_insert);
	break;
	case "delete" :
		$sql_update = "delete  from board_check where pc_id='$pc_id'";
