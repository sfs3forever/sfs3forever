...
$SFS_MODULE_SETUP[]=array('var'=>"IS_STANDALONE", 'msg'=>"是否有獨立的界面(1是,0否)", 'value'=>0);
$SFS_MODULE_SETUP[]=array('var'=>"DESIGN_NAME", 'msg'=>"供應廠商(以逗號「 , 」區隔)", 'value'=>"甲卡飽");
$SFS_MODULE_SETUP[]=array('var'=>"font_size", 'msg'=>"瀏覽時的字體大小", 'value'=>"9px");
$SFS_MODULE_SETUP[]=array('var'=>"column_bgcolor_w", 'msg'=>"週顯示模式時的欄位標題的底色", 'value'=>"#FFDDDD");
$SFS_MODULE_SETUP[]=array('var'=>"column_bgcolor_m", 'msg'=>"月顯示模式時的欄位標題的底色", 'value'=>"#DDDDFF");
$SFS_MODULE_SETUP[]=array('var'=>"WEEK_DAYS", 'msg'=>"週顯示模式時的食譜列出天數", 'value'=>array(5=>5,6=>6,7=>7));
