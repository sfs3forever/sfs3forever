...
<tr><td> $year_seme_menu 出差人:$leave_teacher_menu  $month  $d_check4_menu</td>
</tr>";
...
if($isAdmin)
echo "<tr bgcolor=#cccccc><td> $sel_year  學年度第 $sel_seme 學期  $abs_name  $abs_month (全校) </td></tr>";
else 
echo "<tr bgcolor=#cccccc><td> $sel_year  學年度第 $sel_seme 學期  $abs_name  $abs_month (本處室)</td></tr>";
