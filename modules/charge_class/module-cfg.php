...
//目錄內程式
$MENU_P = array(
"list.php"=>"收費名單","decrease.php"=>"減免設定","received.php"=>"繳款登錄","record.php"=>"紀錄維護","hie.php"=>"催繳清冊","class_summary.php"=>"班級統計","detail_summary.php"=>"細目統計","help.php"=>"模組說明");
...
$SFS_MODULE_SETUP[0] =
        array('var'=>"is_list", 'msg'=>"收費名單? ( 是/否 )", 'value'=>$IS_MODULE_ARR);
$SFS_MODULE_SETUP[1] =
        array('var'=>"is_decrease", 'msg'=>"減免設定? ( 是/否 )", 'value'=>$IS_MODULE_ARR);
$SFS_MODULE_SETUP[2] =
        array('var'=>"is_received", 'msg'=>"繳款登錄? ( 是/否 )", 'value'=>$IS_MODULE_ARR);
$SFS_MODULE_SETUP[3] =
        array('var'=>"is_record", 'msg'=>"紀錄維護? ( 是/否 )", 'value'=>$IS_MODULE_ARR);
$SFS_MODULE_SETUP[4] =
        array('var'=>"is_hie", 'msg'=>"催繳清冊? ( 是/否 )", 'value'=>$IS_MODULE_ARR);
$SFS_MODULE_SETUP[5] =
        array('var'=>"is_class_summary", 'msg'=>"班級統計? ( 是/否 )", 'value'=>$IS_MODULE_ARR);
$SFS_MODULE_SETUP[6] =
        array('var'=>"is_detail_summary", 'msg'=>"細目統計? ( 是/否 )", 'value'=>$IS_MODULE_ARR);
?>
