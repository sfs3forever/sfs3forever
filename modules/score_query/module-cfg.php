...
// 待填
//$MENU_P = array("select_query1.php"=>"成績綜合查詢", );
$class_year_name=array("100"=>"全一年級","200"=>"全二年級","300"=>"全三年級","400"=>"全四年級","500"=>"全五年級","600"=>"全六年級","700"=>"全七年級","800"=>"全八年級","900"=>"全九年級","1000"=>"全十年級","1100"=>"全十一年級","1200"=>"全十二年級",);
$stage_cname=array("1"=>"第一階段","2"=>"第二階段","3"=>"第三階段","4"=>"第四階段","5"=>"第五階段","6"=>"第六階段","7"=>"第七階段","8"=>"第八階段","9"=>"第九階段","10"=>"第十階段","254"=>"平時總成績","255"=>"全學期");
//---------------------------------------------------
//
...
// 使用法：
//
// $ret_array =& get_module_setup("score_query")
//
//
