...
//目錄內程式
$school_menu_p = array(
"resit_setup.php"=>"學期補考設定",
"resit_score.php"=>"補考名單相關作業",
"resit_assign.php"=>"命題補考考卷",
"resit_output.php"=>"匯出補考分數",
"resit_readme.php"=>"操作說明",
);
