...
// 模組最後更新日期
$MODULE_UPDATE="2003-4-7 12:50:00";
...
//
//---------------------------------------------------
$school_kind_name=array("幼稚園","小一","小二","小三","小四","小五","小六","國一","國二","國三","高一","高二","高三");
$msg1="<br>每頁顯示資料筆數請由系統管理->模組權限管理->變數調整，進行調整。";
//---------------------------------------------------
//
...
$SFS_MODULE_SETUP[0] =array('var'=>"limit", 'msg'=>"每頁顯示資料筆數", 'value'=>10);
?>
