{{* $Id: stud_basic_test_distest4_print_tcc.tpl 5891 2010-03-08 05:45:29Z brucelyc $ *}}
...
{{/foreach}}
		  <TD style="border-right: windowtext 0.75pt solid; border-top: windowtext 1.5pt solid; border-bottom: windowtext 1.5pt solid;"
		  colSpan="3">{{$rowdata.$sn.9991.avg.avg.score}}</TD>
		  ...
		  colSpan="3">{{$rowdata.$sn.9991.avg.avg.pr}}</TD>
	</TR>
        <TR style="height: 0pt;">
          <TD colSpan="20"></TD>
		</TR>
		...
		<TR>
		  ...
		  <TR>
		    ...
		    <TD>各國中應分別呈現學生在本國語文、英語、數學、自然與生活科技、社會等五大科目總成績之PR值。</TD>
		  </TR>
		  </TABLE>
		</TR>
