<?php
//$Id: module-cfg.php 5456 2009-04-23 08:32:09Z infodaes $
...
$MODULE_TABLE_NAME[0] = "magazine";
$MODULE_TABLE_NAME[1] = "magazine_chap";
$MODULE_TABLE_NAME[2] = "magazine_paper";
...
$MODULE_MAN = 1 ;
//管理權說明
$MODULE_MAN_DESCRIPTION = "具有管理權人員,才可增修期別";
...
//---------------------------------------------------
    ...
    $chap_mode = array("作文","圖檔","班級訊息","網頁","SWF動畫");

    
    //目錄內程式
    $m_menu_p = array("paper_list.php"=>"上傳稿件",
	   "mag_doc.php"=>"使用辦法說明",
     "a_main.php"=>"[*]期別管理" , 
     "ed_list_paper.php"=>"[*]文章列出" , 
     "tmp_magazine.php"=>"[*]編輯中校刊",
     "magazine.php"=>"完稿電子校刊"
     );    
