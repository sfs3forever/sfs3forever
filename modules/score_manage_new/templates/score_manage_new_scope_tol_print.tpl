{{* $Id: score_manage_new_scope_tol_print.tpl 6530 2011-09-21 08:55:51Z infodaes $ *}}
<html>
<head><meta http-equiv="Content-Type" content="text/html; charset=big5">
<title>學習領域學期成績總表</title>
</head>
...
<tr align="right">
<td colspan="{{$ss_num+5}}"><b>{{$class_base[$seme_class]}} 學習領域學期成績總表　　　　　 <font size="1" style="font-size: 10pt">列印日期：{{$smarty.now|date_format}}</font></b></td>
</tr>
<tr align="center">
...
{{/if}}
{{if $sl=="chinese"}}<td rowspan="{{$area_rowspan}}" style="border-style:solid; border-width:0pt 1.5pt 0.75pt 0.75pt;">{{$fin_score.$sn.avg.score}}<br>({{$fin_score.$sn.avg.str}})</td>{{/if}}
</tr>
{{/foreach}}
<tr align="center">
