...
// $Id: module-cfg.php 6605 2011-10-25 07:47:18Z infodaes $
...
$SFS_MODULE_SETUP[0]=array('var'=>"default_cword", 'msg'=>"轉學證明書預設字", 'value'=>'潭秀教轉');
$SFS_MODULE_SETUP[1]=array('var'=>"default_pword", 'msg'=>"成績證明書預設字", 'value'=>'OO成績證');
$SFS_MODULE_SETUP[2]=array('var'=>"no_seme_avg", 'msg'=>"取消學期平均", 'value'=>array('0'=>'否','1'=>'是'));

// $SFS_MODULE_SETUP[2] =
//	array('var'=>"ssss", 'msg'=>"tttt", 'value'=>1);
$menu_p = array(
"score_certi.php"=>"成績證明",
"certi_htm.php"=>"成績證明(網頁式)",
"chc_sco_prt.php"=>"成績證明(彰縣版)",
"read_make.php"=>"自訂說明"
);
