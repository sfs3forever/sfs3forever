...
// 資料表名稱定義
$MODULE_TABLE_NAME=array(0=>"sport_main", 1=>"sport_item",2=>"sport_res",3=>"sport_teach",4=>"sport_var");
...
/*
*/
$school_menu_p1 = array(
"teach.php"=>"比賽報名",
"teach.1.php"=>"填寫比賽編號"
);

$school_menu_p2 = array(
"mgr_stu.php"=>"□報名管理",
"mgr_stu.1.php"=>"□比賽編號管理",
"mgr_order.php"=>"□初賽檢錄",
"mgr_special.php"=>"□接力檢錄",
"mgr_input.php"=>"□成績輸入",
"mgr_order2.php"=>"□晉級檢錄",
"mgr_prt.php"=>"□名冊輸出"
);
$school_menu_p3 = array(
"ad_main.php"=>"□比賽管理",
"ad_teach.php"=>"□人員授權",
"ad_item.php"=>"□比賽項目管理",
"admin.php"=>"□系統選項管理",
