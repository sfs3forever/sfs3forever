...
//選單
$menu_p = array("signList.php"=>"報名單列表","help.php"=>"輔助說明","signAdmin.php"=>"*新增報名單");
...
$SFS_MODULE_SETUP[0] =
	array('var'=>"MAX_ITEM", 'msg'=>"預設最多可參加組別數", 'value'=>4);
	
$SFS_MODULE_SETUP[1] =
	array('var'=>"MAX_INPUT_FIELD", 'msg'=>"預設最多額外輸入欄位數", 'value'=>5);

$SFS_MODULE_SETUP[2] =
	array('var'=>"MAX_RECORD", 'msg'=>"列示筆數", 'value'=>20);
