...
$MODULE_TABLE_NAME[0] = "stud_club_setup";  //社團期初設定
$MODULE_TABLE_NAME[1] = "stud_club_base";   //社團基本資料
$MODULE_TABLE_NAME[2] = "stud_club_temp";   //社團學生選課暫存資料
$MODULE_TABLE_NAME[3] = "association";      //社團學生成績
...
$school_menu_p = array(
"club_list.php"=>"社團一覽表",
"club_score.php"=>"社團成績輸入",
"club_class.php"=>"列印班級名單",
"club_print.php"=>"列印社團名單",
"club_no_feedback.php"=>"列印自我省思未填寫名單",
"club_manage.php"=>"社團管理",
"club_arrange.php"=>"社團編班",
"club_score2.php"=>"成績補登",
"club_entrance.php"=>"轉學生補登他校資料",
"club_import.php"=>"手動匯入成績",
"club_score_all.php"=>"查詢學生歷年記錄",
"club_score_edit.php"=>"成績資料庫異動",
"club_readme.php"=>"操作說明"
);
