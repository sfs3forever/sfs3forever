...
$MODULE_TABLE_NAME[0] = "class_report_setup";  			//成績單設定
$MODULE_TABLE_NAME[1] = "class_report_test";				//每次考試科目設定
$MODULE_TABLE_NAME[2] = "class_report_score";				//每次考試學生成績
...
"rep_index.php"=>"觀看成績單",
"rep_input.php"=>"輸入成績",
"rep_manage.php"=>"成績單管理",
"rep_submit.php"=>"匯入階段成績",
"rep_readme.php"=>"操作說明"
);
...
$SFS_MODULE_SETUP[]=array('var'=>'pages', 'msg'=>'每頁顯示幾筆', 'value'=>'10');
$SFS_MODULE_SETUP[]=array('var'=>'limit_open', 'msg'=>'允許教師開放學生查詢成績', 'value'=>array('1'=>'是',''=>'否'));
$SFS_MODULE_SETUP[]=array('var'=>'limit_classmates', 'msg'=>'允許教師開放讓學生查詢全班成績單', 'value'=>array(''=>'否','1'=>'是'));
$SFS_MODULE_SETUP[]=array('var'=>'limit_rank', 'msg'=>'允許教師提供成績單排名查詢', 'value'=>array(''=>'否','1'=>'是'));
$SFS_MODULE_SETUP[]=array('var'=>'unlock_self', 'msg'=>'允許教師自行解鎖成績單', 'value'=>array(''=>'否','1'=>'是'));
