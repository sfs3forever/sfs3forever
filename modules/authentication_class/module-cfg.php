...
//目錄內程式
$MENU_P = array("empower.php"=>"認證授權","authentication.php"=>"項目別認證登錄","authentication2.php"=>"學生別認證登錄","barcode_auth.php"=>"條碼掃瞄認證登錄","student_report.php"=>"個人列表","class_report.php"=>"*班級統計*","student_rank.php"=>"*排行榜*");
