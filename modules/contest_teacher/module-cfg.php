...
$MODULE_TABLE_NAME[12] = "contest_typebank";   			//打字比賽題庫
$MODULE_TABLE_NAME[13] = "contest_typerec";   			//打字比賽記錄
...
$MODULE_PRO_KIND_NAME = "中市網競-教師模組";
...
//	array('var'=>"ssss", 'msg'=>"tttt", 'value'=>1);
 ...
 $SFS_MODULE_SETUP[1] =
	array('var'=>"page", 'msg'=>"每頁顯示筆數", 'value'=>"10");

 $SFS_MODULE_SETUP[2] =
	array('var'=>"upload_file_attr", 'msg'=>"允許上傳的檔案屬性", 'value'=>"jpeg;jpg;gif;png;doc;ppt;xls;docx;xlsx;pptx;odp;otp;odt;pdf;swf;sb2");
