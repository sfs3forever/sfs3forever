{{* $Id: health_disease_gr.tpl 5594 2009-08-20 01:39:39Z brucelyc $ *}}
...
<tr>
<td colspan="7" style="color:white;text-align:center;">個人疾病史</td>
</tr>
<tr bgcolor="#f4feff">
<td>座號</td><td>姓名</td><td>診斷代號</td><td>疾病名稱</td><td>陳述</td><td>處置</td><td>功能選項</td>
</tr>
...
{{foreach from=$health_data->stud_base.$sn.disease item=ddd}}
...
<td>　</td>
<td>
<input type="checkbox" id="a_{{$sn}}" name="update[{{$sn}}][health_disease][di_id]" OnClick="get_item('a_{{$sn}}');" {{if $sn==$tempsn}}disabled{{/if}}>
<input type="image" src="images/edit.gif" alt="編輯這筆資料" OnClick="document.getElementById('act').value='disease_st';document.getElementById('sn').value='{{$sn}}';document.myform.target='new';document.myform.submit();">
<input type="image" src="images/delete.gif" alt="刪除這筆資料" OnClick="document.getElementById('del').name='del[{{$sn}}][health_disease][di_id]';document.getElementById('del').value='{{$ddd}}';document.myform.submit();">
</td>
</tr>
...
<td>-----</td>
<td>
<input type="checkbox" id="a_{{$sn}}" name="update[{{$sn}}][health_disease][di_id]" OnClick="get_item('a_{{$sn}}');">
<input type="image" src="images/edit.gif" alt="編輯這筆資料" OnClick="document.getElementById('act').value='disease_st';document.getElementById('sn').value='{{$sn}}';document.myform.target='new';document.myform.submit();">
</td>
</tr>
{{/foreach}}
...
<table bgcolor="#9ebcdd" cellspacing="1" cellpadding="4" width="100%" class="small">
<tr>
<td colspan="3" style="color:white;text-align:center;">個人疾病史選項</td>
</tr>
...
<input type="hidden" id="sn" name="student_sn" value="{{$smarty.post.student_sn}}">
