...
// $Id: module-cfg.php 8696 2015-12-25 09:03:14Z qfon $
...
$IS_MODULE_ARR2 = array("y"=>"是","n"=>"否");
$SFS_MODULE_SETUP[0] =array('var'=>"yorn", 'msg'=>"是否每次月考配合一次平時成績", 'value'=>$IS_MODULE_ARR2);
$SFS_MODULE_SETUP[1] =array('var'=>"is_allow", 'msg'=>"是否開放科(專)任老師授權給級任老師(導師)更改成績", 'value'=>$IS_MODULE_ARR);
$SFS_MODULE_SETUP[2] =array('var'=>"is_print", 'msg'=>"是否開放科(專)任老師觀看各班成績單", 'value'=>$IS_MODULE_ARR);
$SFS_MODULE_SETUP[3] =array('var'=>"is_new_nor", 'msg'=>"允許任課者自行增加或刪除平時成績項目", 'value'=>$IS_MODULE_ARR2);
$SFS_MODULE_SETUP[4] =array('var'=>"is_mod_nor", 'msg'=>"允許任課者自行修改平時成績項目名稱或加權", 'value'=>$IS_MODULE_ARR2);
$SFS_MODULE_SETUP[5] =array('var'=>"pic_checked", 'msg'=>"登打成績時顯示大頭照", 'value'=>array("0"=>"否","1"=>"是"));
$SFS_MODULE_SETUP[6] =array('var'=>"pic_width", 'msg'=>"大頭照顯示的寬度", 'value'=>'60');
$SFS_MODULE_SETUP[7] =array('var'=>"score_analyse", 'msg'=>"是否顯示階段成績分析", 'value'=>array("0"=>"否","1"=>"是"));
?>