...
// 模組最後更新版本
$MODULE_UPDATE_VER="1.3.0";

// 模組最後更新日期
$MODULE_UPDATE="2005-05-21";
...
$menu_p = array(
"sign_form.php"=>"人數總表",
"class_grade2.php"=>"各班調整",
"grad_score.php"=>"畢業成績",
"disgrad.php"=>"修業建議名單",
"disgrad_101.php"=>"101畢業條件",
"grad_word.php"=>"畢業字號",
"prolin.php"=>"名冊列印",
...
"grad_edit.php"=>"例外編修",
"edu_txt.php"=>"教育程度資料檔",
"edu_shs.php"=>"後期中等教育資料檔",
'reUpgrade.php' => '升級資料庫', 
'graduate.php' => '歷屆畢業生名冊', 
"readme.php"=>"說明");
...
$SFS_MODULE_SETUP[0] =
	array('var'=>"grade_word", 'msg'=>"畢業證書字號", 'value'=>"南營畢字");
$SFS_MODULE_SETUP[1] =
	array('var'=>"grade_num_len", 'msg'=>"畢業證書號位數", 'value'=>3);
$SFS_MODULE_SETUP[2] =
	array('var'=>"G_SCHOOL_NAME", 'msg'=>"升學學校", 'value'=>"臺中市OO國民中學,臺中市OO國民中學,臺中市OO國民中學");	
$SFS_MODULE_SETUP[3] =
	array('var'=>"UP_YEAR", 'msg'=>"畢業年級", 'value'=>6);		
