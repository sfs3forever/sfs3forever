...
// $Id: module-cfg.php 8879 2016-04-22 00:42:06Z chiming $
...
$MODULE_TABLE_NAME[0] = "fitness_data";
$MODULE_TABLE_NAME[1] = "fitness_mod";
...
// 模組最後更新版本
$MODULE_UPDATE_VER="v1.1";

// 模組最後更新日期
$MODULE_UPDATE="2007/01/01";
...
//$SFS_MODULE_SETUP[0] =array('var'=>"yorn", 'msg'=>"填y或n，是否每次月考配合一次平時成績", 'value'=>'y');
//$SFS_MODULE_SETUP[1] =array('var'=>"is_allow", 'msg'=>"填y或n，是否開放科(專)任老師授權給級任老師(導師)更改成績", 'value'=>'y');
//$SFS_MODULE_SETUP[2] =array('var'=>"is_print", 'msg'=>"填y或n，是否開放科(專)任老師觀看各班成績單", 'value'=>'n');
