...
//目錄內程式
$toxml_menu = array("output_xml_3_K12.php"=>"資科司XML 3.0匯出(國前署)","check_xml_client.php"=>"本地端XML檢查","check_xml.php"=>"伺服器端XML檢查");
