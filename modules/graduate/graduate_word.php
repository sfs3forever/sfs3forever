<?php
//$Id: graduate_word.php 5310 2009-01-10 07:57:56Z hami $
include "config.php";
...
if ($_POST[year_name]) {
	...
	$query="select a.student_sn,a.stud_id,b.stud_name,a.seme_class,a.seme_num from stud_seme a,stud_base b left join grad_stud c on b.stud_id=c.stud_id where a.seme_year_seme='$seme_year_seme' and a.student_sn=b.student_sn and b.stud_study_cond in ('0','15') $kind_str $seme_class_str order by a.seme_class,a.seme_num";
	$res=$CONN->Execute($query);
	while(!$res->EOF) {
...
$smarty->display("graduate_graduate_word.tpl");
?>