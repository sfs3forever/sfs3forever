<?php
//$Id: module-cfg.php 7853 2014-01-13 07:11:36Z brucelyc $
...
// 模組最後更新版本
$MODULE_UPDATE_VER="1.1.0";

// 模組最後更新日期
$MODULE_UPDATE="2009-06-03";
...
//目錄內程式
$school_menu_p = array(
"bad_login.php"=>"登入失敗記錄",
"login_rec.php"=>"登入成功記錄",
"chk_login_img.php"=>"登入圖片檢查",
"del_temp.php"=>"刪除網頁暫存檔",
"optimize.php"=>"資料庫最佳化",
"theme_setup.php"=>"佈景設定",
"file_man.php"=>"檔案管理",
"update.php"=>"更新時間設定",
"cdc_setup.php"=>"憑證登入設定",
"ssl_setup.php"=>"https啟用設定",
"fix_link.php"=>"連結列修正"
);
/*
"acc.php"=>"系統加速設定"
