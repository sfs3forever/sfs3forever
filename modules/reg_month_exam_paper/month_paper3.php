<?php
// $Id: month_paper3.php 9141 2017-09-08 02:25:42Z smallduh $
...
if($act=="dl_pdf" ){//pdf報表產出
	...
	if($class_num){
		...
		if($test_sort)	$download="<td nowrap  align='left' width='96%'><font style='border: 2px outset #EAF6FF'><a href='{$_SERVER['PHP_SELF']}?act=dl_pdf&test_sort=$test_sort&class_num=$class_num&add_nor=$add_nor&add_wet=$add_wet'>下載PDF</a></font></td>";
