...
$MODULE_TABLE_NAME[0] = "comp_roomsite";  			 //電腦教室座位
...
//目錄內程式
$school_menu_p = array(
"comp_classroom.php"=>"電腦教室上網管理",
"comp_classroom_set.php"=>"設定電腦教室座位",
"comp_classroom_access.php"=>"設定例外網路IP",
"comp_firewall_test.php"=>"防火牆登入測試",
"readme.php"=>"重要說明"
);
...
// 第2,3,4....個，依此類推： 
 ...
 $SFS_MODULE_SETUP[1] =
	array('var'=>"firewall_ip", 'msg'=>"防火牆IP", 'value'=>"");

 $SFS_MODULE_SETUP[2] =
     array('var'=>"firewall_user", 'msg'=>"防火牆登入帳號", 'value'=>"");

 $SFS_MODULE_SETUP[3] =
    array('var'=>"firewall_pwd", 'msg'=>"防火牆登入密碼", 'value'=>"");

 $SFS_MODULE_SETUP[4] =
    array('var'=>"addrgrp_deny", 'msg'=>"防火牆deny群組名稱(建議用預設值)", 'value'=>"sfs3_comp_out_deny");

 $SFS_MODULE_SETUP[5] =
    array('var'=>"addrgrp_deny_tag", 'msg'=>"為建立deny群組而設的假ip", 'value'=>"1.1.1.1");

 $SFS_MODULE_SETUP[6] =
    array('var'=>"addrgrp_access", 'msg'=>"防火牆access群組名稱(建議用預設值)", 'value'=>"sfs3_comp_out_access");

 $SFS_MODULE_SETUP[7] =
    array('var'=>"addrgrp_comp_all", 'msg'=>"電腦教室ip群組名稱(建議用預設值)", 'value'=>"sfs3_comp_all");

 $SFS_MODULE_SETUP[8] =
    array('var'=>"VDOM", 'msg'=>"是否啟用VDOM(虛擬防火牆功能)", 'value'=>array(0=>"否",1=>"是"));
