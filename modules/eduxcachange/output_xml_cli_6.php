...
//取出所有記錄
//(只列一個年級測速度)
$stud_query = "select * from stud_base where stud_study_cond in (0,15) and substring(curr_class_num,1,1)=6 order by curr_class_num";
...
$filename_xml = $SCHOOL_BASE['sch_id'] . "_XML_6.xml";
//將smarty輸出的資料先cache住
ob_start();
