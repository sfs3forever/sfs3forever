...
//
//---------------------------------------------------
$eduxcachange_menu = array("toxml.php"=>"主頁面","upload_edu_xml_test.php"=>"上傳測試","output_xml.php"=>"產生XML資料","upload_edu_xml.php"=>"學生學籍上傳","download_edu_studmove.php"=>"取得學生交換資料");
...
$SFS_MODULE_SETUP[1] =array('var'=>"ex_school_name", 'msg'=>"學校名稱", 'value'=>trim($SCHOOL_BASE['sch_cname']));
$SFS_MODULE_SETUP[2] =array('var'=>"ex_school_id", 'msg'=>"教育部代碼", 'value'=>trim($SCHOOL_BASE['sch_id']));
$SFS_MODULE_SETUP[3] =array('var'=>"ex_school_city", 'msg'=>"所在縣市", 'value'=>trim($SCHOOL_BASE['sch_sheng']));
$SFS_MODULE_SETUP[4] =array('var'=>"ex_school_city_id", 'msg'=>"縣市代碼", 'value'=>"19");
