...
// $Id: module-cfg.php 6723 2012-03-15 00:43:06Z infodaes $
...
//---------------------------------------------------
$SFS_MODULE_SETUP[0] =
	array('var'=>"daymm", 'msg'=>"前 m天不受理", 'value'=>0);
$SFS_MODULE_SETUP[1] =
	array('var'=>"dayww", 'msg'=>" w天範圍受理預約", 'value'=>7);
$VAL=array("0"=>"否","1"=>"是");
$SFS_MODULE_SETUP[2] =
	array('var'=>"saturday", 'msg'=>"星期六受理預約", 'value'=>$VAL);
$SFS_MODULE_SETUP[3] =
	array('var'=>"sunday", 'msg'=>"星期日受理預約", 'value'=>$VAL);
$SFS_MODULE_SETUP[4] =
	array('var'=>"after_school", 'msg'=>"正式課程後可預約的節數", 'value'=>3);
