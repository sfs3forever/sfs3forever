...
$MODULE_TABLE_NAME[0] = "net_base";  			    //設備資料
$MODULE_TABLE_NAME[1] = "net_roomsite";  			//電腦教室座位
$MODULE_TABLE_NAME[2] = "net_firewall";  			//防火牆密碼
...
$school_menu_p = array(
"net_list.php"=>"資訊設備一覽",
"net_classroom.php"=>"電腦教室上網管理",
"net_edit.php"=>"設定資訊設備",
"net_classroom_set.php"=>"設定電腦教室",
"net_check.php"=>"防火牆IP-MAC功能檢測",
"readme.php"=>"重要說明"
);
