...
//程式使用的Smarty樣本檔
$template_file = dirname (__file__)."/templates/stud_listA.htm";
...
class chc_seme{
	...
	var $xOspecial2=array('0'=>'0.一般生','1'=>'1.智能障礙','2'=>'2.視覺障礙','3'=>'3.聽覺障礙','4'=>'4.語言障礙','5'=>'5.肢體障礙','6'=>'6.身體病弱','7'=>'7.情緒行為障礙','8'=>'8.學習障礙','9'=>'9.多重障礙','A'=>'A.自閉症','B'=>'B.其他障礙'	);
	//障礙類別 -- fix
...
//		echo'<pre>';print_r($_POST);die();
		...
		$fields=array('sn','student_sn','kind_id','special','unemployed', 'graduation','income','score_balance','score_nearby');
		...
		$SQL="update chc_basic12 set `kind_id`='{$kind_id}' ,
		`special`='{$special}' ,`unemployed`='{$unemployed}' ,
		`graduation`='{$graduation}' ,`income`='{$income}' ,
		`score_nearby`='{$score_nearby}' ,`score_balance`='{$score_balance}' ,`score_club`='{$score_club}' ,
		 update_sn = '{$session_tea_sn}'  
