...
// 模組外顯名稱(供 "模組設定" 程式使用)
$MODULE_DISPLAY_NAME="訊息傳遞";

// 模組隸屬群組
$MODULE_GROUP_NAME="教師區";
...
//種類陣列
$kind_array=array("校務","級務","私事","公事","其他");
...
$SFS_MODULE_SETUP[] =
	array('var'=>"page_unit", 'msg'=>"已送訊息每頁顯示筆數", 'value'=>5);

$SFS_MODULE_SETUP[] =
	array('var'=>"page_count", 'msg'=>"送訊息時接收者下接式選單個數", 'value'=>10);
?>