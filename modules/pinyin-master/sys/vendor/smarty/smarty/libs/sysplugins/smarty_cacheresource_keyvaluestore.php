 ...
 * 罈a|b|c竄 is a good depth where 罈a|b|c|d|e|f|g|h|i|j|k竄 isn't. Try to join correlating
 * cache groups: if your cache groups look somewhat like 罈a|b|$page|$items|$whatever竄
 * consider using 罈a|b|c|$page-$items-$whatever竄 instead.
 *
 * @package    Smarty
 * @subpackage Cacher
 * @author     Rodney Rehm
