...
$menu_p = array("address_book2.php"=>"通訊錄", "chi_addr.php"=>"通訊錄2","select_behalf.php"=>"家長委員圈選表","stud_rep.php"=>"學生一覽表","stud_data_dump.php"=>"基本資料匯出") ;
//---------------------------------------------------
//
