CREATE TABLE IF NOT EXISTS `12basic_tech` (
  ...
  `particular_score` tinyint(3) unsigned DEFAULT NULL,
  `particular_memo` varchar(100) DEFAULT NULL,
  ...
  `score_adaptive_domicile` tinyint(3) unsigned DEFAULT NULL,
  `score_adaptive_tutor` tinyint(3) unsigned DEFAULT NULL,
  `score_adaptive_guidance` tinyint(3) unsigned DEFAULT NULL,
  `personality_memo` varchar(100) NOT NULL,
  `others_item` text,
  `others_memo` varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `12basic_kind_tech` (
  `sn` int(10) unsigned NOT NULL auto_increment,
