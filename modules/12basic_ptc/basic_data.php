...
if($stud_class)
{
	...
	$studentdata="<tr align='center' bgcolor='#ff8888'><td>座號</td><td>姓名</td><td>大頭照</td><td>學號</td><td>身分證字號</td><td>年</td><td>月</td><td>日</td><td>家長姓名</td><td>市內電話</td><td>行動電話</td><td>郵遞區號</td><td>地址</td>";
	while(!$rs->EOF) {
		...
		$studentdata.="<tr align='center' bgcolor='$stud_sex_color' $java_script><td>$seme_num</td><td>$stud_name</td><td width=$pic_width>$my_pic</td><td>$stud_id</td><td>$stud_person_id</td><td>$birth_year</td><td>$birth_month</td><td>$birth_day</td><td>$guardian_name</td><td>$guardian_phone</td><td>$guardian_hand_phone</td><td>$addr_zip</td><td align='left'>$guardian_address $action</td></tr>";
