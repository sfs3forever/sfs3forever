...
$MODULE_PRO_KIND_NAME = "匯入廳版行政系統資料";
...
//目錄內程式
$menu_p = array(
"trans_score.php"=>"匯入成績",
"trans_absent.php"=>"匯入出缺席",
"trans_reward.php"=>"匯入獎懲",
"trans_nor.php"=>"匯入平時表現",
"trans_memo.php"=>"匯入評語"
);
