...
*/
// 2013.11.28 by smallduh ?斗???怠?頝臬?
//$baseUrl = '/ckfinder/userfiles/';
$baseUrl="";
$B_dir=explode("/",substr($_SERVER['PHP_SELF'],1));
for ($i=0;$i<count($B_dir)-8;$i++) {
 $baseUrl.="/".$B_dir[$i];
}
$baseUrl.="/data/school/jboard/tmp/";
/*
...
If enabled, characters with diactric marks, like 疇, 瓣, 繹, ?, ?, ?, 禳
