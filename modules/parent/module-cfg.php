...
$MODULE_TABLE_NAME[1] = "parent_auth";
...
// 模組最後更新日期
$MODULE_UPDATE="2003-5-1 12:50:00";
...
$parent_menu_p = array(
"index.php"=>"家庭聯絡簿",
"index.php?act=score"=>"成績查詢",
"index.php?act=absent"=>"出缺席查詢",
"index.php?act=chpass"=>"修改密碼"
);
