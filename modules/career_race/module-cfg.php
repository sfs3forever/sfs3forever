...
$MODULE_TABLE_NAME[0] = "career_race";  			//資料表1
...
$SFS_MODULE_SETUP[1] = array('var'=>"rank_select", 'msg'=>"競賽獲獎項目", 'value'=>'第一名,冠軍,金牌,特優,第二名,亞軍,銀牌,優等,第三名,季軍,銅牌,甲等,第四名,殿軍,佳作,第五名,入選,第六名');
$SFS_MODULE_SETUP[2] = array('var'=>"nature_select", 'msg'=>"競賽類別", 'value'=>'體育類,科學類,語文類,音樂類,美術類,舞蹈類,技藝類');
