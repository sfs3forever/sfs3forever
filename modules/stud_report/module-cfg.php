...
// $Id: module-cfg.php 7026 2012-12-03 04:04:36Z infodaes $
...
$school_menu_p=array("index.php"=>"學籍成績紀錄表","index2_html.php"=>"輔導記錄表","chc_index.php"=>"網頁式學籍記錄表(彰縣)","chc_abs.php"=>"缺曠課統計","chc_years_score.php"=>"歷屆成績","chc_stage_score.php"=>"歷屆段考(彰縣)");
//,"index2_add.php"=>"輔導訪談記錄貼條"
$menu_p = $school_menu_p;
?>