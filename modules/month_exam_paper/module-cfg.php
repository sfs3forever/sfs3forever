...
// 待填
//列出橫向的連結選單模組
$menu_p = array("month_paper1.php"=>"總表", "month_paper2.php"=>"個人成績單","month_paper3.php"=>"總表(彈性)", "month_paper4.php"=>"個人成績單(彈性)", "chc_seme_rank_class.php"=>"班級進退步名次");
...
// 使用法：
//
// $ret_array =& get_module_setup("month_exam_paper")
//
//
