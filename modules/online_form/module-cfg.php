...
// $Id: module-cfg.php 5798 2009-12-19 04:31:57Z infodaes $
...
$MODULE_TABLE_NAME[0] = "form_all";
$MODULE_TABLE_NAME[1] = "form_col";
$MODULE_TABLE_NAME[2] = "form_fill_in";
$MODULE_TABLE_NAME[3] = "form_value";
...
"index.php"=>"填寫填報",
"form_admin.php"=>"管理填報",
"form_admin.php?act=add"=>"新增填報",
"form_copy.php"=>"項目複製",
"form_admin.php?act=view_demo"=>"說明範例"
);
