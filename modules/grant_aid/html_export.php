...
foreach($student_arr as $key=>$value){
	...
	$data.="<tr bgcolor='#FFFFFF' height=$height>
        ...
        if(($num_count % $rows==0) or $no==$student_arr_len) {
                ...
                $main.="<font face='標楷體'><CENTER><H2>".$school_area.$work_year."學年度發放就讀本縣公立國民中小學<BR>原住民族學生學用費印領清冊</H2>[ 請加蓋關防，否則無效 ]<BR><BR><BR>學校名稱：$school_short_name 　　　學校代號：$school_id 　　　　　填報日期：$today<BR>
                <font face='新細明體'><table border='1' style='border-collapse: collapse' bordercolor='#006600' width='96%' cellspacing='1' cellpadding='3'>
                <tr bgcolor=$hint_color height=20><td align='center'>編號</td><td align='center'>班級</td><td align='center'>學號</td><td align='center'>姓名</td><td align='center'>身分證字號</td><td align='center'>原住民族別</td><td align='center'>金額(元)</td><td align='center'>學生簽章</td></tr>
                $data
                </CENTER><tr><td colspan=8>※ 本頁小計：人數： $num_count 人，金額： $total 元整。<BR>※ 累計原住民學生數： $allnum 人，申請補助金額：新台幣 $alldollar 元整。</td></tr></table><font face='標楷體'><BR>$sign ";
...
$main="<font face='標楷體'><CENTER><BR><BR><BR><BR><BR><BR><H1>".$school_area.$work_year."學年度<BR>發放就讀本縣公立國民中小學<BR><BR><BR>《原住民族學生學用費》<BR><BR>印領清冊封面</H1><BR><BR><BR>
