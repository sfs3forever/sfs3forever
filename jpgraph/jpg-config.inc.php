...
// Created: 	2004-03-27
// Ver:		$Id: jpg-config.inc.php 5310 2009-01-10 07:57:56Z hami $
//
...
DEFINE("CSIMCACHE_DIR","$SFS_PATH/data/csimcache/"); 
DEFINE("CSIMCACHE_HTTP_DIR","$SFS_PATH/data/csimcache/");
...
DEFINE('CHINESE_TTF_FONT','bsmi00lp.ttf');
//DEFINE('CHINESE_TTF_FONT','ukai.ttc');
