...
class TC_OID_BASE{
  ...
  public function beginAuth($openid){
    ...
    if (!$auth_request) { $this->displayError("隤??航炊嚗????董??); }
  ...
  private function createTCaxs(){
    ...
    $attribute[] = Auth_OpenID_AX_AttrInfo::make('http://openid.tc.edu.tw/schema/1.0/edusid',1,1, 'edusid');
    $attribute[] = Auth_OpenID_AX_AttrInfo::make('http://openid.tc.edu.tw/schema/1.0/subtitle',1,1, 'subtitle');
    $attribute[] = Auth_OpenID_AX_AttrInfo::make('http://openid.tc.edu.tw/schema/1.0/tcguid',1,1, 'tcguid');
    return $attribute;
  }
...
class PHC_OID_BASE{
    ...
    private function createTCaxs(){
        ...
        // See http://code.google.com/apis/accounts/docs/OpenID.html#Parameters for parameters
        // Usage: make($type_uri, $count=1, $required=false, $alias=null)
        $attribute[] = Auth_OpenID_AX_AttrInfo::make('http://openid.phc.edu.tw/schema/1.0/schooldistrict',1,1, 'schooldistrict');
        $attribute[] = Auth_OpenID_AX_AttrInfo::make('http://openid.phc.edu.tw/schema/1.0/schoolname',1,1, 'schoolname');
        $attribute[] = Auth_OpenID_AX_AttrInfo::make('http://openid.phc.edu.tw/schema/1.0/schooltitle',1,1, 'schooltitle');
        $attribute[] = Auth_OpenID_AX_AttrInfo::make('http://openid.phc.edu.tw/schema/1.0/schooltype',1,1, 'schooltype');
        $attribute[] = Auth_OpenID_AX_AttrInfo::make('http://openid.phc.edu.tw/schema/1.0/edusid',1,1, 'edusid');
        $attribute[] = Auth_OpenID_AX_AttrInfo::make('http://openid.phc.edu.tw/schema/1.0/subtitle',1,1, 'subtitle');
        $attribute[] = Auth_OpenID_AX_AttrInfo::make('http://openid.phc.edu.tw/schema/1.0/tcguid',1,1, 'tcguid');
        return $attribute;
    }
