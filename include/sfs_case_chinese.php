<?php
//$Id: sfs_case_chinese.php 5310 2009-01-10 07:57:56Z hami $
require('sfs_case_fpdf.php');
...
function new_MultiCell($w,$h,$txt,$border=0,$align='L',$fill=0)
{
	if($this->CurrentFont['type']=='Type0')
		$this->new_MBMultiCell($w,$h,$txt,$border,$align,$fill);
	else
		parent::new_MultiCell($w,$h,$txt,$border,$align,$fill);
}

function new_MBMultiCell($w,$h,$txt,$border=0,$align='L',$fill=0)
{
	//Multi-byte version of MultiCell()
	$cy=$this->y;
	$cw=&$this->CurrentFont['cw'];
