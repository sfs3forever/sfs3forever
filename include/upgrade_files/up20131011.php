...
$SQL="CREATE VIEW teacher_course_view AS SELECT b.edu_key, b.name,a.teacher_sn,a.class_year,a.class_name,a.class_id,a.year,a.semester,a.ss_id, d.subject_name FROM score_course a , teacher_base b ,score_ss c,score_subject d WHERE b.teach_condition=0 AND a.teacher_sn=b.teacher_sn AND a.ss_id=c.ss_id AND c.subject_id=d.subject_id GROUP BY  a.teacher_sn,a.class_id,a.ss_id ORDER BY a.teacher_sn;";
$rs=$CONN->Execute($SQL);
