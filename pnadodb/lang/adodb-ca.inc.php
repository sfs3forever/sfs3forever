<?php
//$Id: adodb-ca.inc.php 5310 2009-01-10 07:57:56Z hami $
// Catalan language
...
$ADODB_LANG_ARRAY = array (
            ...
            DB_ERROR_INVALID            => 'no 廥 v跐id',
            DB_ERROR_INVALID_DATE       => 'la data o l\'hora no s鏮 v跐ides',
            DB_ERROR_INVALID_NUMBER     => 'el nombre no 廥 v跐id',
            DB_ERROR_MISMATCH           => 'no hi ha coincid鋝cia',
            ...
            DB_ERROR_NOT_CAPABLE        => 'l\'execuci?secund跫ia de DB no pot',
            ...
            DB_ERROR_INVALID_DSN        => 'el DSN no 廥 v跐id',
            DB_ERROR_CONNECT_FAILED     => 'connexi?fallida',
            0	                       => 'cap error', // DB_OK
            DB_ERROR_NEED_MORE_DATA     => 'les dades subministrades s鏮 insuficients',
