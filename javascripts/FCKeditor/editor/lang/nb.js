 ...
 * == END LICENSE ==
 *
 * Norwegian Bokm疇l language file.
 $Id: nb.js 5311 2009-01-10 08:11:55Z hami $
 */
...
ToolbarCollapse		: "Skjul verkt繪ylinje",
ToolbarExpand		: "Vis verkt繪ylinje",
...
RightJustify		: "H繪yrejuster",
BlockJustify		: "Blokkjuster",
DecreaseIndent		: "Senk niv疇",
IncreaseIndent		: "?k niv疇",
Undo				: "Angre",
Redo				: "Gj繪r om",
...
TextField		: "Tekstfelt",
Textarea		: "Tekstomr疇de",
HiddenField		: "Skjult felt",
Button			: "Knapp",
SelectionField	: "Dropdown meny",
ImageButton		: "Bildeknapp",

FitWindow		: "Maksimer st繪rrelsen p疇 redigeringsverkt繪yet",
...
Done				: "Ferdig",
PasteWordConfirm	: "Teksten du pr繪ver 疇 lime inn ser ut som om den kommer fra word , du b繪r rense den f繪r du limer inn , vil du gj繪re dette?",
NotCompatiblePaste	: "Denne kommandoen er tilgjenglig kun for Internet Explorer version 5.5 eller bedre. Vil du fortsette uten 疇 rense?(Du kan lime inn som ren tekst)",
UnknownToolbarItem	: "Ukjent menyvalg \"%1\"",
UnknownCommand		: "Ukjent kommando \"%1\"",
NotImplemented		: "Kommando ikke enn疇 implimentert",
UnknownToolbarSet	: "Verkt繪ylinjesett \"%1\" finnes ikke",
NoActiveX			: "Din nettleser's sikkerhetsinstillinger kan begrense noen av funksjonene i redigeringsverkt繪yet. Du m疇 aktivere \"Kj繪r ActiveXkontroller og plugins\". Du kan oppleve feil og advarsler om manglende funksjoner",
BrowseServerBlocked : "Kunne ikke 疇pne dialogboksen for filarkiv. Pass p疇 at du har sl疇tt av popupstoppere.",
DialogBlocked		: "Kunne ikke 疇pne dialogboksen. Pass p疇 at du har sl疇tt av popupstoppere.",
...
DlgGenId			: "Id",
DlgGenLangDir		: "Spr疇kretning",
DlgGenLangDirLtr	: "Venstre til h繪yre (VTH)",
DlgGenLangDirRtl	: "H繪yre til venstre (HTV)",
DlgGenLangCode		: "Spr疇k kode",
...
DlgGenTitle			: "Tittel",
DlgGenContType		: "Type",
DlgGenLinkCharset	: "Lenket spr疇kkart",
DlgGenStyle			: "Stil",
...
DlgImgWidth			: "Bredde",
DlgImgHeight		: "H繪yde",
DlgImgLockRatio		: "L疇s forhold",
DlgBtnResetSize		: "Tilbakestill st繪rrelse",
DlgImgBorder		: "Ramme",
DlgImgHSpace		: "HMarg",
DlgImgVSpace		: "VMarg",
DlgImgAlign			: "Juster",
...
DlgImgAlignRight	: "H繪yre",
DlgImgAlignTextTop	: "Tekst topp",
DlgImgAlignTop		: "Topp",
DlgImgPreview		: "Forh疇ndsvis",
...
DlgFlashChkMenu		: "Sl疇 p疇 Flash meny",
DlgFlashScale		: "Skaler",
DlgFlashScaleAll	: "Vis alt",
DlgFlashScaleNoBorder	: "Ingen ramme",
DlgFlashScaleFit	: "Skaler til 疇 passeExact Fit",
...
DlnLnkMsgInvPopName	: "Popup vinduets navn m疇 begynne med en bokstav, og kan ikke inneholde mellomrom",

// Color Dialog
DlgColorTitle		: "Velg farge",
DlgColorBtnClear	: "T繪m",
...
DlgPasteMsg2	: "Vennligst lim inn i den f繪lgende boksen med tastaturet (<STRONG>Ctrl+V</STRONG>) og trykk <STRONG>OK</STRONG>.",
DlgPasteSec		: "Because of your browser security settings, the editor is not able to access your clipboard data directly. You are required to paste it again in this window.",	//MISSING
DlgPasteIgnoreFont		: "Fjern skrifttyper",
DlgPasteRemoveStyles	: "Fjern stildefinisjoner",
DlgPasteCleanBox		: "T繪m boksen",
...
DlgSpellProgress		: "Stavekontroll p疇g疇r...",
DlgSpellNoMispell		: "Stavekontroll fullf繪rt: ingen feilstavinger funnet",
DlgSpellNoChanges		: "Stavekontroll fullf繪rt: ingen ord endret",
DlgSpellOneChange		: "Stavekontroll fullf繪rt: Ett ord endret",
DlgSpellManyChanges		: "Stavekontroll fullf繪rt: %1 ord endret",

IeSpellDownload			: "Stavekontroll ikke installert, vil du laste den ned n疇?",
...
DlgLstTypeLCase		: "Sm疇 bokstaver (a, b, c)",
DlgLstTypeUCase		: "Store bokstaver(A, B, C)",
DlgLstTypeSRoman	: "Sm疇 romerske tall(i, ii, iii)",
...
DlgDocLangDir		: "Spr疇kretning",
DlgDocLangDirLTR	: "Venstre til h繪yre (LTR)",
DlgDocLangDirRTL	: "H繪yre til venstre (RTL)",
DlgDocLangCode		: "Spr疇kkode",
...
DlgDocMaRight		: "H繪yre",
DlgDocMaBottom		: "Bunn",
DlgDocMeIndex		: "Dokument n繪kkelord (kommaseparert)",
DlgDocMeDescr		: "Dokumentbeskrivelse",
DlgDocMeAuthor		: "Forfatter",
DlgDocMeCopy		: "Kopirett",
DlgDocPreview		: "Forh疇ndsvising",

// Templates Dialog
Templates			: "Maler",
DlgTemplatesTitle	: "Innholdsmaler",
DlgTemplatesSelMsg	: "Velg malen du vil 疇pne<br>(innholdet du har skrevet blir tapt!):",
