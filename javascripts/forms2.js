...
var fileTag ="<input type='"+fieldType+"' value='' name='"+fieldName+"_"+numFields+"' id='"+fieldName+"_"+numFields+"' onchange='return filecheck(this)'>";
...
numFields++;
    ...
    if( debug) window.alert('adding field ' + newFieldName);
      if (document.all) { 
        ...
        input.onchange='return filecheck(this)';
      }
      else if (document.getElementById) { 
        input.setAttribute('type', fieldType);
        input.setAttribute('name', newFieldName);
        input.setAttribute('id', newFieldName);
        input.setAttribute('value', fieldValue);
        input.setAttribute('onchange', 'return filecheck(this)');
      }
